...
INSERT INTO `avoir_note` VALUES (1,1,1,15),(2,2,1,8),(3,3,1,7),(4,4,1,11),(5,5,1,15),(6,6,1,16),(7,7,1,1),(8,17,1,6),(9,18,1,11),(10,1,2,12),(11,2,2,12),(12,3,2,3),(13,4,2,15),(14,5,2,9),(15,6,2,11),(16,7,2,13),(17,17,2,19),(18,18,2,6),(19,8,3,8),(20,9,3,14),(21,10,3,14),(22,11,3,11),(23,12,3,6),(24,13,3,3),(25,14,3,20),(26,15,3,12),(27,16,3,11),(28,8,4,7),(29,9,4,11),(30,10,4,12),(31,11,4,3),(32,12,4,20),(33,13,4,12),(34,14,4,10),(35,15,4,8),(36,16,4,10),(37,17,4,8),(42,17,3,12),(43,18,4,15),(44,18,4,6),(45,18,4,9);
/*!40000 ALTER TABLE `avoir_note` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `enseignant_matieres`
--

DROP TABLE IF EXISTS `enseignant_matieres`;
/*!50001 DROP VIEW IF EXISTS `enseignant_matieres`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `enseignant_matieres` AS SELECT 
 1 AS `idEnseignant`,
 1 AS `nomEnseignant`,
 1 AS `prenomEnseignant`,
 1 AS `fonctionEnseignant`,
 1 AS `adresseEnseignant`,
 1 AS `villeEnseignant`,
 1 AS `codePostalEnseignant`,
 1 AS `telephoneEnseignant`,
 1 AS `dateNaissanceEnseignant`,
 1 AS `dateEmbaucheEnseignant`,
 1 AS `idFaireCours`,
 1 AS `annee`,
 1 AS `idMatiere`,
 1 AS `nomMatiere`,
 1 AS `idModule`,
 1 AS `coefficientMatiere`*/;
...
--
-- Temporary table structure for view `etudiants_epreuves`
--

DROP TABLE IF EXISTS `etudiants_epreuves`;
/*!50001 DROP VIEW IF EXISTS `etudiants_epreuves`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `etudiants_epreuves` AS SELECT 
 1 AS `idEtudiant`,
 1 AS `nomEtudiant`,
 1 AS `prenomEtudiant`,
...
--
-- Final view structure for view `enseignant_matieres`
--
...
/*!50001 VIEW `enseignant_matieres` AS select `en`.`idEnseignant` AS `idEnseignant`,`en`.`nomEnseignant` AS `nomEnseignant`,`en`.`prenomEnseignant` AS `prenomEnseignant`,`en`.`fonctionEnseignant` AS `fonctionEnseignant`,`en`.`adresseEnseignant` AS `adresseEnseignant`,`en`.`villeEnseignant` AS `villeEnseignant`,`en`.`codePostalEnseignant` AS `codePostalEnseignant`,`en`.`telephoneEnseignant` AS `telephoneEnseignant`,`en`.`dateNaissanceEnseignant` AS `dateNaissanceEnseignant`,`en`.`dateEmbaucheEnseignant` AS `dateEmbaucheEnseignant`,`fc`.`idFaireCours` AS `idFaireCours`,`fc`.`annee` AS `annee`,`m`.`idMatiere` AS `idMatiere`,`m`.`nomMatiere` AS `nomMatiere`,`m`.`idModule` AS `idModule`,`m`.`coefficientMatiere` AS `coefficientMatiere` from ((`enseignants` `en` join `faire_cours` `fc` on((`fc`.`idEnseignant` = `en`.`idEnseignant`))) join `matieres` `m` on((`m`.`idMatiere` = `fc`.`idMatiere`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `etudiants_epreuves`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `etudiants_epreuves` AS select `e`.`idEtudiant` AS `idEtudiant`,`e`.`nomEtudiant` AS `nomEtudiant`,`e`.`prenomEtudiant` AS `prenomEtudiant`,`e`.`adresseEtudiant` AS `adresseEtudiant`,`e`.`villeEtudiant` AS `villeEtudiant`,`e`.`codePostalEtudiant` AS `codePostalEtudiant`,`e`.`telephoneEtudiant` AS `telephoneEtudiant`,`e`.`dateEntreeEtudiant` AS `dateEntreeEtudiant`,`e`.`anneeEtudiant` AS `anneeEtudiant`,`e`.`remarqueEtudiant` AS `remarqueEtudiant`,`e`.`sexeEtudiant` AS `sexeEtudiant`,`e`.`dateNaissanceEtudiant` AS `dateNaissanceEtudiant`,`e`.`HOBBY` AS `HOBBY`,`ep`.`idEpreuve` AS `idEpreuve`,`ep`.`libelleEpreuve` AS `libelleEpreuve`,`ep`.`idEnseignantEpreuve` AS `idEnseignantEpreuve`,`ep`.`idMatiereEpreuve` AS `idMatiereEpreuve`,`ep`.`dateEpreuve` AS `dateEpreuve`,`ep`.`CoefficientEpreuve` AS `CoefficientEpreuve`,`ep`.`anneeEpreuve` AS `anneeEpreuve`,`a`.`note` AS `note`,`a`.`idAvoirNote` AS `idAvoirNote` from ((`etudiants` `e` join `avoir_note` `a` on((`a`.`idEtudiant` = `e`.`idEtudiant`))) join `epreuves` `ep` on((`ep`.`idEpreuve` = `a`.`idEpreuve`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
